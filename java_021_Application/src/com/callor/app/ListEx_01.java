...
public class ListEx_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Collections 클래스는
		 * List와 같은 데이터들을 관리하는 클래스의 부모 클래스
		 * 
		 * Collections.sort는(ListType 데이터 를 매개 변수로 받음)
		 * return 값을 사용하는 것이 아니고
		 * 매개 변수로 전달된 값 자체를 변형함
		 * 
		 */
		Collections.sort(intList); // -> 어떤 값을 정렬
		for(Integer n : intList) {
			System.out.print(n + "\t");
		}
		 ...
		 * 	원래 intNum1, intNum2에는 아무런 영향을 미치지 않는다
		 */
		int intNum1 = 50;
		int intNum2 = 30;
		add(intNum1, intNum2);
